...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'subject_pool_ostromlabfaqentry', (
        ...
        db.send_create_signal(u'subject_pool', ['OstromlabFaqEntry'])


    def backwards(self, orm):
        # Deleting model 'OstromlabFaqEntry'
        db.delete_table(u'subject_pool_ostromlabfaqentry')
    ...
    models = {
        ...
        u'subject_pool.ostromlabfaqentry': {
