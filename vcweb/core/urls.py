...
from vcweb.core.views import (dashboard, LoginView, LogoutView, monitor,  #RegistrationView,
                              ...
                              check_survey_completed, Participate, download_data, export_configuration, api_logger,
...
urlpatterns = patterns('vcweb.core.views',
                       ...
                       url(r'^participant/session-signup/$', experiment_session_signup,
                           name='experiment_session_signup'),
                       ...
                       url(r'^participate/(?P<pk>\d+)/check-survey-completed', check_survey_completed,
                           name='check_survey_completed'),
                       ...
                       url(r'^experiment/(?P<pk>\d+)/register-email-list$', RegisterEmailListView.as_view(),
                           name='register_email_list'),
                       ...
                       url(r'^experiment/(?P<pk>\d+)/download/(?P<file_type>[\w]+)$', download_data,
                           name='download_data'),
                       ...
                       url(r'^api/configuration/round/(?P<pk>\-?\d+)$', update_round_configuration,
                           name='update_round_configuration'),
                       url(r'^api/configuration/round/param/(?P<pk>\-?\d+)$', update_round_param_value,
                           name='update_round_param_value'),
