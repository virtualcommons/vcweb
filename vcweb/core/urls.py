...
urlpatterns = patterns('vcweb.core.views',
    ...
    url(r'^participant/session-signup/$', experiment_session_signup, name='experiment_session_signup'),
    url(r'^participant/session/$', experiment_session_signup, ), # FIXME: duplicate alias, remove soon
