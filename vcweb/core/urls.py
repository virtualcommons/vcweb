...
from .views import (dashboard, LoginView, LogoutView, monitor, RegisterEmailListView, RegisterTestParticipantsView,
                    ...
                    check_ready_participants, get_dashboard_view_model, update_experiment, update_round_configuration,
                    show_experiment_configuration, edit_experiment_configuration, delete_experiment_configuration,
                    ...
                    handle_chat_message, update_participants,
                    )
...
urlpatterns = [
    ...
    url(r'^api/experiment/(?P<pk>\d+)/chat/submit$', handle_chat_message, name='handle_chat_messasge'),
...
#                v=settings.FOURSQUAthe RE_CONSUMER_DATE_VERIFIED)
#
#
