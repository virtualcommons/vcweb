...
urlpatterns = [
    ...
    url(r'^cas/asu/submit/$', cas_asu_registration_submit,
        name='cas_asu_registration_submit'),
    url(r'^dashboard/$', dashboard, name='dashboard'),
    url(r'^accounts/login/$', LoginView.as_view(), name='login'),
    url(r'^accounts/logout/$',
        login_required(LogoutView.as_view()), name='logout'),
    ...
    url(r'^participate/survey-completed',
        completed_survey, name='survey_completed'),
    url(r'^participate/(?P<pk>\d+)/check-survey-completed',
        check_survey_completed, name='check_survey_completed'),
    url(r'^experiment/participant-ready$',
        participant_ready, name='participant_ready'),
    url(r'^experiment/(?P<pk>\d+)/monitor$',
        monitor, name='monitor_experiment'),
