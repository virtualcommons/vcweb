...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('core_participant', 'gender',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1, blank=True),
                      keep_default=False)

        # Adding field 'Participant.birthdate'
        db.add_column('core_participant', 'birthdate',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Participant.address'
        db.add_column('core_participant', 'address',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Address'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('core_participant', 'gender')

        # Deleting field 'Participant.birthdate'
        db.delete_column('core_participant', 'birthdate')

        # Deleting field 'Participant.address'
        db.delete_column('core_participant', 'address_id')
