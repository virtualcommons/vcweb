...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Experiment.current_round_elapsed_time'
        db.delete_column(u'core_experiment', 'current_round_elapsed_time')


    def backwards(self, orm):
        # Adding field 'Experiment.current_round_elapsed_time'
        db.add_column(u'core_experiment', 'current_round_elapsed_time',
