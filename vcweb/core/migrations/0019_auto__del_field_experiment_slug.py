...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Experiment.slug'
        db.delete_column(u'core_experiment', 'slug')


    def backwards(self, orm):
        # Adding field 'Experiment.slug'
        db.add_column(u'core_experiment', 'slug',
                      self.gf('django.db.models.fields.SlugField')(unique=True, max_length=32, null=True, blank=True),
                      keep_default=False)
