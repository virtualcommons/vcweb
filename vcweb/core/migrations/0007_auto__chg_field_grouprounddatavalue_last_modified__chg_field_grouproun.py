...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GroupRoundDataValue.last_modified'
        db.alter_column('core_grouprounddatavalue', 'last_modified', self.gf('vcweb.core.models.AutoDateTimeField')())

        # Changing field 'GroupRoundDataValue.date_created'
        db.alter_column('core_grouprounddatavalue', 'date_created', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'RoundConfiguration.last_modified'
        db.alter_column('core_roundconfiguration', 'last_modified', self.gf('vcweb.core.models.AutoDateTimeField')())

        # Changing field 'RoundConfiguration.date_created'
        db.alter_column('core_roundconfiguration', 'date_created', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Parameter.last_modified'
        db.alter_column('core_parameter', 'last_modified', self.gf('vcweb.core.models.AutoDateTimeField')())

        # Changing field 'Parameter.date_created'
        db.alter_column('core_parameter', 'date_created', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'ParticipantExperimentRelationship.date_created'
        db.alter_column('core_participantexperimentrelationship', 'date_created', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'ActivityLog.date_created'
        db.alter_column('core_activitylog', 'date_created', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'ExperimentSession.date_created'
        db.alter_column('core_experimentsession', 'date_created', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'RoundParameterValue.last_modified'
        db.alter_column('core_roundparametervalue', 'last_modified', self.gf('vcweb.core.models.AutoDateTimeField')())

        # Changing field 'RoundParameterValue.date_created'
        db.alter_column('core_roundparametervalue', 'date_created', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'ExperimenterRequest.date_created'
        db.alter_column('core_experimenterrequest', 'date_created', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Invitation.date_created'
        db.alter_column('core_invitation', 'date_created', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'ParticipantRoundDataValue.last_modified'
        db.alter_column('core_participantrounddatavalue', 'last_modified', self.gf('vcweb.core.models.AutoDateTimeField')())

        # Changing field 'ParticipantRoundDataValue.date_created'
        db.alter_column('core_participantrounddatavalue', 'date_created', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'ExperimentMetadata.last_modified'
        db.alter_column('core_experimentmetadata', 'last_modified', self.gf('vcweb.core.models.AutoDateTimeField')())

        # Changing field 'ExperimentMetadata.date_created'
        db.alter_column('core_experimentmetadata', 'date_created', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'ParticipantSignup.date_created'
        db.alter_column('core_participantsignup', 'date_created', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'ParticipantGroupRelationship.notifications_since'
        db.alter_column('core_participantgrouprelationship', 'notifications_since', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'ParticipantGroupRelationship.date_created'
        db.alter_column('core_participantgrouprelationship', 'date_created', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Experiment.last_modified'
        db.alter_column('core_experiment', 'last_modified', self.gf('vcweb.core.models.AutoDateTimeField')())

        # Changing field 'Experiment.date_created'
        db.alter_column('core_experiment', 'date_created', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Institution.last_modified'
        db.alter_column('core_institution', 'last_modified', self.gf('vcweb.core.models.AutoDateTimeField')())

        # Changing field 'Institution.date_created'
        db.alter_column('core_institution', 'date_created', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'ExperimentConfiguration.last_modified'
        db.alter_column('core_experimentconfiguration', 'last_modified', self.gf('vcweb.core.models.AutoDateTimeField')())

        # Changing field 'ExperimentConfiguration.date_created'
        db.alter_column('core_experimentconfiguration', 'date_created', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'GroupRoundDataValue.last_modified'
        db.alter_column('core_grouprounddatavalue', 'last_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'GroupRoundDataValue.date_created'
        db.alter_column('core_grouprounddatavalue', 'date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'RoundConfiguration.last_modified'
        db.alter_column('core_roundconfiguration', 'last_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'RoundConfiguration.date_created'
        db.alter_column('core_roundconfiguration', 'date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Parameter.last_modified'
        db.alter_column('core_parameter', 'last_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Parameter.date_created'
        db.alter_column('core_parameter', 'date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'ParticipantExperimentRelationship.date_created'
        db.alter_column('core_participantexperimentrelationship', 'date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'ActivityLog.date_created'
        db.alter_column('core_activitylog', 'date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'ExperimentSession.date_created'
        db.alter_column('core_experimentsession', 'date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'RoundParameterValue.last_modified'
        db.alter_column('core_roundparametervalue', 'last_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'RoundParameterValue.date_created'
        db.alter_column('core_roundparametervalue', 'date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'ExperimenterRequest.date_created'
        db.alter_column('core_experimenterrequest', 'date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Invitation.date_created'
        db.alter_column('core_invitation', 'date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'ParticipantRoundDataValue.last_modified'
        db.alter_column('core_participantrounddatavalue', 'last_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'ParticipantRoundDataValue.date_created'
        db.alter_column('core_participantrounddatavalue', 'date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'ExperimentMetadata.last_modified'
        db.alter_column('core_experimentmetadata', 'last_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'ExperimentMetadata.date_created'
        db.alter_column('core_experimentmetadata', 'date_created', self.gf('django.db.models.fields.DateField')(auto_now_add=True))

        # Changing field 'ParticipantSignup.date_created'
        db.alter_column('core_participantsignup', 'date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'ParticipantGroupRelationship.notifications_since'
        db.alter_column('core_participantgrouprelationship', 'notifications_since', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True))

        # Changing field 'ParticipantGroupRelationship.date_created'
        db.alter_column('core_participantgrouprelationship', 'date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Experiment.last_modified'
        db.alter_column('core_experiment', 'last_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Experiment.date_created'
        db.alter_column('core_experiment', 'date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Institution.last_modified'
        db.alter_column('core_institution', 'last_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Institution.date_created'
        db.alter_column('core_institution', 'date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'ExperimentConfiguration.last_modified'
        db.alter_column('core_experimentconfiguration', 'last_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'ExperimentConfiguration.date_created'
        db.alter_column('core_experimentconfiguration', 'date_created', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
