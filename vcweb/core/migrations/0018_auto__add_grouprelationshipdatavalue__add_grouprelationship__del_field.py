...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_grouprelationship', (
            ...
            ('first_group', self.gf('django.db.models.fields.related.ForeignKey')(related_name='first_group_relationship_set', to=orm['core.Group'])),
            ('second_group', self.gf('django.db.models.fields.related.ForeignKey')(related_name='second_group_relationship_set', to=orm['core.Group'])),
        ))
    ...
    models = {
        ...
        u'core.group': {
            ...
            'related_groups': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['core.Group']", 'through': u"orm['core.GroupRelationship']", 'symmetrical': 'False'}),
        ...
        u'core.grouprelationship': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'first_group': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'first_group_relationship_set'", 'to': u"orm['core.Group']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'second_group': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'second_group_relationship_set'", 'to': u"orm['core.Group']"})
        },
        u'core.grouprelationshipdatavalue': {
            'Meta': {'object_name': 'GroupRelationshipDataValue'},
            'boolean_value': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'db_index': 'True'}),
            'float_value': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'group_relationship': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.GroupRelationship']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'int_value': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'last_modified': ('vcweb.core.models.AutoDateTimeField', [], {'default': 'datetime.datetime.now'}),
            'parameter': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Parameter']"}),
            'round_data': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'group_relationship_data_value_set'", 'to': u"orm['core.RoundData']"}),
            'string_value': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'})
        },
