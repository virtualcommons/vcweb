...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ParticipantGroupRelationship.survey_completed'
        db.add_column(u'core_participantgrouprelationship', 'survey_completed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ParticipantGroupRelationship.survey_completed'
        db.delete_column(u'core_participantgrouprelationship', 'survey_completed')
