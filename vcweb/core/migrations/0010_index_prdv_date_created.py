...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'GroupRoundDataValue', fields ['date_created']
        db.create_index('core_grouprounddatavalue', ['date_created'])

        # Adding index on 'RoundParameterValue', fields ['date_created']
        db.create_index('core_roundparametervalue', ['date_created'])

        # Adding index on 'ParticipantRoundDataValue', fields ['date_created']
        db.create_index('core_participantrounddatavalue', ['date_created'])


    def backwards(self, orm):
        # Removing index on 'ParticipantRoundDataValue', fields ['date_created']
        db.delete_index('core_participantrounddatavalue', ['date_created'])

        # Removing index on 'RoundParameterValue', fields ['date_created']
        db.delete_index('core_roundparametervalue', ['date_created'])

        # Removing index on 'GroupRoundDataValue', fields ['date_created']
        db.delete_index('core_grouprounddatavalue', ['date_created'])
