...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BookmarkedExperimentMetadata'
        db.create_table(u'core_bookmarkedexperimentmetadata', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('experimenter', self.gf('django.db.models.fields.related.ForeignKey')(related_name='bookmarked_experiment_metadata_set', to=orm['core.Experimenter'])),
            ('experiment_metadata', self.gf('django.db.models.fields.related.ForeignKey')(related_name='bookmarked_experiment_metadata_set', to=orm['core.ExperimentMetadata'])),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
        ))
        db.send_create_signal(u'core', ['BookmarkedExperimentMetadata'])

        # Adding unique constraint on 'BookmarkedExperimentMetadata', fields ['experimenter', 'experiment_metadata']
        db.create_unique(u'core_bookmarkedexperimentmetadata', ['experimenter_id', 'experiment_metadata_id'])

        # Adding field 'RoundConfiguration.initialize_data_values'
        db.add_column(u'core_roundconfiguration', 'initialize_data_values',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'BookmarkedExperimentMetadata', fields ['experimenter', 'experiment_metadata']
        db.delete_unique(u'core_bookmarkedexperimentmetadata', ['experimenter_id', 'experiment_metadata_id'])

        # Deleting model 'BookmarkedExperimentMetadata'
        db.delete_table(u'core_bookmarkedexperimentmetadata')

        # Deleting field 'RoundConfiguration.initialize_data_values'
        db.delete_column(u'core_roundconfiguration', 'initialize_data_values')
