...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RoundConfiguration.group_cluster_size'
        db.alter_column(u'core_roundconfiguration', 'group_cluster_size', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'RoundConfiguration.group_cluster_size'
        db.alter_column(u'core_roundconfiguration', 'group_cluster_size', self.gf('django.db.models.fields.PositiveIntegerField')())
