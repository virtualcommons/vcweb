...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'core_institution', 'acronym',
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'core_quizquestion', (
            ...
            ('experiment', self.gf('django.db.models.fields.related.ForeignKey')(related_name='default_quiz_question_set', null=True, to=orm['core.Experiment'], blank=True)),
        ...
        db.delete_column(u'core_institution', 'acronym')
