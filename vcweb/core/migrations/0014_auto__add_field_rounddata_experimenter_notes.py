...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RoundData.experimenter_notes'
        db.add_column(u'core_rounddata', 'experimenter_notes',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RoundData.experimenter_notes'
        db.delete_column(u'core_rounddata', 'experimenter_notes')
