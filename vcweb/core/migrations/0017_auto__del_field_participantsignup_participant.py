...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ParticipantSignup.participant'
        db.delete_column(u'core_participantsignup', 'participant_id')


    def backwards(self, orm):
        # Adding field 'ParticipantSignup.participant'
        db.add_column(u'core_participantsignup', 'participant',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='signup_set', to=orm['core.Participant']),
                      keep_default=False)
