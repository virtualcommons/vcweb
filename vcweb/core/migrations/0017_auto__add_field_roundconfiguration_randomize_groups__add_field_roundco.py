...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RoundConfiguration.randomize_groups'
        db.add_column(u'core_roundconfiguration', 'randomize_groups',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'RoundConfiguration.preserve_existing_groups'
        db.add_column(u'core_roundconfiguration', 'preserve_existing_groups',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'RoundConfiguration.session_id'
        db.add_column(u'core_roundconfiguration', 'session_id',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Group.session_id'
        db.add_column(u'core_group', 'session_id',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RoundConfiguration.randomize_groups'
        db.delete_column(u'core_roundconfiguration', 'randomize_groups')

        # Deleting field 'RoundConfiguration.preserve_existing_groups'
        db.delete_column(u'core_roundconfiguration', 'preserve_existing_groups')

        # Deleting field 'RoundConfiguration.session_id'
        db.delete_column(u'core_roundconfiguration', 'session_id')

        # Deleting field 'Group.session_id'
        db.delete_column(u'core_group', 'session_id')
