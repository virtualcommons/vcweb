...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExperimentConfiguration.treatment_id'
        db.add_column(u'core_experimentconfiguration', 'treatment_id',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExperimentConfiguration.treatment_id'
        db.delete_column(u'core_experimentconfiguration', 'treatment_id')
