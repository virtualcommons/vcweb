...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Participant.favorite_sport'
        db.add_column(u'core_participant', 'favorite_sport',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True),
                      keep_default=False)

        # Adding field 'Participant.favorite_color'
        db.add_column(u'core_participant', 'favorite_color',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True),
                      keep_default=False)

        # Adding field 'Participant.favorite_food'
        db.add_column(u'core_participant', 'favorite_food',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True),
                      keep_default=False)

        # Adding field 'Participant.favorite_movie_genre'
        db.add_column(u'core_participant', 'favorite_movie_genre',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Participant.favorite_sport'
        db.delete_column(u'core_participant', 'favorite_sport')

        # Deleting field 'Participant.favorite_color'
        db.delete_column(u'core_participant', 'favorite_color')

        # Deleting field 'Participant.favorite_food'
        db.delete_column(u'core_participant', 'favorite_food')

        # Deleting field 'Participant.favorite_movie_genre'
        db.delete_column(u'core_participant', 'favorite_movie_genre')
