...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'GroupRelationshipDataValue'
        db.delete_table(u'core_grouprelationshipdatavalue')
        ...
        # Deleting field 'GroupRelationship.second_group'
        db.delete_column(u'core_grouprelationship', 'second_group_id')

        # Deleting field 'GroupRelationship.first_group'
        db.delete_column(u'core_grouprelationship', 'first_group_id')

        # Adding field 'GroupRelationship.cluster'
        db.add_column(u'core_grouprelationship', 'cluster',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='group_set', to=orm['core.GroupCluster']),
                      keep_default=False)

        # Adding field 'GroupRelationship.group'
        db.add_column(u'core_grouprelationship', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['core.Group']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding model 'GroupRelationshipDataValue'
        db.create_table(u'core_grouprelationshipdatavalue', (
            ('string_value', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('last_modified', self.gf('vcweb.core.models.AutoDateTimeField')(default=datetime.datetime.now)),
            ('float_value', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('round_data', self.gf('django.db.models.fields.related.ForeignKey')(related_name='group_relationship_data_value_set', to=orm['core.RoundData'])),
            ('boolean_value', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('group_relationship', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.GroupRelationship'])),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('int_value', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, db_index=True)),
            ('parameter', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Parameter'])),
        ))
        db.send_create_signal(u'core', ['GroupRelationshipDataValue'])
        ...
        # User chose to not deal with backwards NULL issues for 'GroupRelationship.second_group'
        raise RuntimeError("Cannot reverse this migration. 'GroupRelationship.second_group' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'GroupRelationship.first_group'
        raise RuntimeError("Cannot reverse this migration. 'GroupRelationship.first_group' and its values cannot be restored.")
        # Deleting field 'GroupRelationship.cluster'
        db.delete_column(u'core_grouprelationship', 'cluster_id')

        # Deleting field 'GroupRelationship.group'
        db.delete_column(u'core_grouprelationship', 'group_id')
