...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExperimentConfiguration.invitation_subject'
        db.add_column('core_experimentconfiguration', 'invitation_subject',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExperimentConfiguration.invitation_subject'
        db.delete_column('core_experimentconfiguration', 'invitation_subject')
