...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('core_experimentsession', (
        ...
        db.send_create_signal('core', ['ExperimentSession'])

        # Adding model 'SpoolParticipantStatistics'
        db.create_table('core_spoolparticipantstatistics', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('core', ['SpoolParticipantStatistics'])
        ...
        db.create_table('core_participantsignup', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('core', ['ParticipantSignup'])

        # Adding field 'ExperimentConfiguration.invitation_text'
        db.add_column('core_experimentconfiguration', 'invitation_text',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting model 'ExperimentSession'
        db.delete_table('core_experimentsession')

        # Deleting model 'SpoolParticipantStatistics'
        db.delete_table('core_spoolparticipantstatistics')

        # Deleting model 'Invitation'
        db.delete_table('core_invitation')

        # Deleting model 'ParticipantSignup'
        db.delete_table('core_participantsignup')

        # Deleting field 'ExperimentConfiguration.invitation_text'
        db.delete_column('core_experimentconfiguration', 'invitation_text')
