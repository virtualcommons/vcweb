...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Experiment.start_date'
        db.add_column(u'core_experiment', 'start_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ExperimentConfiguration.has_daily_rounds'
        db.add_column(u'core_experimentconfiguration', 'has_daily_rounds',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Experiment.start_date'
        db.delete_column(u'core_experiment', 'start_date')

        # Deleting field 'ExperimentConfiguration.has_daily_rounds'
        db.delete_column(u'core_experimentconfiguration', 'has_daily_rounds')
