...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Experiment.slug'
        db.alter_column('core_experiment', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=32, unique=True, null=True))
    def backwards(self, orm):

        # Changing field 'Experiment.slug'
        db.alter_column('core_experiment', 'slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=16, null=True))
    models = {
        'auth.group': {
