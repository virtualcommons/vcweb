...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Experimenter.date_created'
        db.delete_column(u'core_experimenter', 'date_created')

        # Deleting field 'Participant.date_created'
        db.delete_column(u'core_participant', 'date_created')


    def backwards(self, orm):
        # Adding field 'Experimenter.date_created'
        db.add_column(u'core_experimenter', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'Participant.date_created'
        db.add_column(u'core_participant', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)
