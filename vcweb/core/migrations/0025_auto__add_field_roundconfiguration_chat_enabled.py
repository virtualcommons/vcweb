...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RoundConfiguration.chat_enabled'
        db.add_column(u'core_roundconfiguration', 'chat_enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RoundConfiguration.chat_enabled'
        db.delete_column(u'core_roundconfiguration', 'chat_enabled')
