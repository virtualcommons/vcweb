...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExperimentConfiguration.show_up_payment'
        db.add_column(u'core_experimentconfiguration', 'show_up_payment',
                      self.gf('django.db.models.fields.DecimalField')(default=5.0, null=True, max_digits=6, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'ExperimentConfiguration.maximum_payment'
        db.add_column(u'core_experimentconfiguration', 'maximum_payment',
                      self.gf('django.db.models.fields.DecimalField')(default=40.0, null=True, max_digits=6, decimal_places=2, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExperimentConfiguration.show_up_payment'
        db.delete_column(u'core_experimentconfiguration', 'show_up_payment')

        # Deleting field 'ExperimentConfiguration.maximum_payment'
        db.delete_column(u'core_experimentconfiguration', 'maximum_payment')
