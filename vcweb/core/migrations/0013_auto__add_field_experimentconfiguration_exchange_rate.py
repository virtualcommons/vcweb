...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExperimentConfiguration.exchange_rate'
        db.add_column(u'core_experimentconfiguration', 'exchange_rate',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=2, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExperimentConfiguration.exchange_rate'
        db.delete_column(u'core_experimentconfiguration', 'exchange_rate')
