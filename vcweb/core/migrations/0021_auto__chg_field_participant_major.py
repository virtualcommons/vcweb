...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Participant.major'
        db.alter_column(u'core_participant', 'major', self.gf('django.db.models.fields.CharField')(max_length=128))

    def backwards(self, orm):

        # Changing field 'Participant.major'
        db.alter_column(u'core_participant', 'major', self.gf('django.db.models.fields.CharField')(max_length=64))
