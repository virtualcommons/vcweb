...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ParticipantSignup.attendance'
        db.alter_column(u'core_participantsignup', 'attendance', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=1))

    def backwards(self, orm):

        # Changing field 'ParticipantSignup.attendance'
        db.alter_column(u'core_participantsignup', 'attendance', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=1, null=True))
