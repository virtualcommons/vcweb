...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Experimenter.institution_username'
        db.delete_column(u'core_experimenter', 'institution_username')

        # Deleting field 'Participant.institution_username'
        db.delete_column(u'core_participant', 'institution_username')


        # Changing field 'ExperimentMetadata.namespace'
        db.alter_column(u'core_experimentmetadata', 'namespace', self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True))

    def backwards(self, orm):
        # Adding field 'Experimenter.institution_username'
        db.add_column(u'core_experimenter', 'institution_username',
                      self.gf('vcweb.core.models.NullCharField')(unique=True, max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Participant.institution_username'
        db.add_column(u'core_participant', 'institution_username',
                      self.gf('vcweb.core.models.NullCharField')(unique=True, max_length=64, null=True, blank=True),
                      keep_default=False)


        # Changing field 'ExperimentMetadata.namespace'
        db.alter_column(u'core_experimentmetadata', 'namespace', self.gf('django.db.models.fields.CharField')(default=None, max_length=255, unique=True))
    ...
    models = {
        ...
        u'core.experimentconfiguration': {
            ...
            'maximum_payment': ('django.db.models.fields.DecimalField', [], {'default': '40.0', 'null': 'True', 'max_digits': '6', 'decimal_places': '2', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'registration_email_subject': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'show_up_payment': ('django.db.models.fields.DecimalField', [], {'default': '5.0', 'null': 'True', 'max_digits': '6', 'decimal_places': '2', 'blank': 'True'}),
        ...
        u'core.experimentmetadata': {
            'Meta': {'ordering': "['title', 'namespace']", 'object_name': 'ExperimentMetadata'},
            ...
            'namespace': ('django.db.models.fields.CharField', [], {'max_length': '255', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'parameters': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['core.Parameter']", 'symmetrical': 'False'}),
        ...
        u'core.experimentsession': {
            'Meta': {'ordering': "['scheduled_date']", 'object_name': 'ExperimentSession'},
        ...
        u'core.invitation': {
            'Meta': {'ordering': "['experiment_session', 'date_created']", 'object_name': 'Invitation'},
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
        ...
        u'core.ostromlabfaqentry': {
            'Meta': {'ordering': "['question', '-date_created']", 'object_name': 'OstromlabFaqEntry'},
        ...
        u'core.participantsignup': {
            'Meta': {'ordering': "['invitation__experiment_session']", 'object_name': 'ParticipantSignup'},
