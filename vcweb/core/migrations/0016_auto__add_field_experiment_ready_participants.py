...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Experiment.ready_participants'
        db.add_column(u'core_experiment', 'ready_participants',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Experiment.ready_participants'
        db.delete_column(u'core_experiment', 'ready_participants')
