...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RoundConfiguration.create_group_clusters'
        db.add_column(u'core_roundconfiguration', 'create_group_clusters',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'RoundConfiguration.group_cluster_size'
        db.add_column(u'core_roundconfiguration', 'group_cluster_size',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RoundConfiguration.create_group_clusters'
        db.delete_column(u'core_roundconfiguration', 'create_group_clusters')

        # Deleting field 'RoundConfiguration.group_cluster_size'
        db.delete_column(u'core_roundconfiguration', 'group_cluster_size')
