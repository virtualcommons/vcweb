...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Parameter.experiment_metadata'
        db.delete_column(u'core_parameter', 'experiment_metadata_id')

        # Adding M2M table for field parameters on 'ExperimentMetadata'
        m2m_table_name = db.shorten_name(u'core_experimentmetadata_parameters')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('experimentmetadata', models.ForeignKey(orm[u'core.experimentmetadata'], null=False)),
            ('parameter', models.ForeignKey(orm[u'core.parameter'], null=False))
        ))
        db.create_unique(m2m_table_name, ['experimentmetadata_id', 'parameter_id'])


    def backwards(self, orm):
        # Adding field 'Parameter.experiment_metadata'
        db.add_column(u'core_parameter', 'experiment_metadata',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.ExperimentMetadata'], null=True, blank=True),
                      keep_default=False)
        ...
        # Removing M2M table for field parameters on 'ExperimentMetadata'
        db.delete_table(db.shorten_name(u'core_experimentmetadata_parameters'))
