...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RoundData.repeating_round_sequence_number'
        db.add_column(u'core_rounddata', 'repeating_round_sequence_number',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RoundData.repeating_round_sequence_number'
        db.delete_column(u'core_rounddata', 'repeating_round_sequence_number')
