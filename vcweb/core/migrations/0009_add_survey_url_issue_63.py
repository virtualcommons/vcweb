...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RoundConfiguration.survey_url'
        db.add_column('core_roundconfiguration', 'survey_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RoundConfiguration.survey_url'
        db.delete_column('core_roundconfiguration', 'survey_url')
