...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GroupCluster.experiment'
        db.add_column(u'core_groupcluster', 'experiment',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['core.Experiment']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GroupCluster.experiment'
        db.delete_column(u'core_groupcluster', 'experiment_id')
