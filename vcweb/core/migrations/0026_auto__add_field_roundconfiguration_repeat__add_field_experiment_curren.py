...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RoundConfiguration.repeat'
        db.add_column(u'core_roundconfiguration', 'repeat',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Experiment.current_repeated_round_sequence_number'
        db.add_column(u'core_experiment', 'current_repeated_round_sequence_number',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RoundConfiguration.repeat'
        db.delete_column(u'core_roundconfiguration', 'repeat')

        # Deleting field 'Experiment.current_repeated_round_sequence_number'
        db.delete_column(u'core_experiment', 'current_repeated_round_sequence_number')
