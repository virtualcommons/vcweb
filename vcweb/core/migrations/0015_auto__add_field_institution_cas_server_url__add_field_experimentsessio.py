...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Institution.cas_server_url'
        db.add_column(u'core_institution', 'cas_server_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ExperimentSession.location'
        db.add_column(u'core_experimentsession', 'location',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)

        # Deleting field 'Experiment.amqp_exchange_name'
        db.delete_column(u'core_experiment', 'amqp_exchange_name')

        # Deleting field 'Experiment.tick_duration'
        db.delete_column(u'core_experiment', 'tick_duration')

        # Adding field 'Experiment.registration_email_subject'
        db.add_column(u'core_experiment', 'registration_email_subject',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)

        # Adding field 'Experiment.registration_email_text'
        db.add_column(u'core_experiment', 'registration_email_text',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # rename field 'ExperimentConfiguration.invitation_subject' to 'ExperimentConfiguration.registration_email_subject'
        db.rename_column(u'core_experimentconfiguration', 'invitation_subject', 'registration_email_subject')


    def backwards(self, orm):
        # Deleting field 'Institution.cas_server_url'
        db.delete_column(u'core_institution', 'cas_server_url')

        # Deleting field 'ExperimentSession.location'
        db.delete_column(u'core_experimentsession', 'location')

        # Adding field 'Experiment.amqp_exchange_name'
        db.add_column(u'core_experiment', 'amqp_exchange_name',
                      self.gf('django.db.models.fields.CharField')(default='vcweb.default.exchange', max_length=64),
                      keep_default=False)

        # Adding field 'Experiment.tick_duration'
        db.add_column(u'core_experiment', 'tick_duration',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True),
                      keep_default=False)

        # Deleting field 'Experiment.registration_email_subject'
        db.delete_column(u'core_experiment', 'registration_email_subject')

        # Deleting field 'Experiment.registration_email_text'
        db.delete_column(u'core_experiment', 'registration_email_text')

        # rename field 'ExperimentConfiguration.registration_email_subject' to 'ExperimentConfiguration.invitation_subject'
        db.rename_column(u'core_experimentconfiguration', 'registration_email_subject', 'invitation_subject')
